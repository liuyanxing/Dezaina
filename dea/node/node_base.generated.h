...
struct GUID {
  ...
  const uint &getSessionID() const { return sessionID; }
  void setSessionID(const uint &v) { sessionID = v; }
  const uint &getLocalID() const { return localID; }
  void setLocalID(const uint &v) { localID = v; }
...
struct Rect {
  ...
  void setW(const float &v) { w = v; }
  const float &getH() const { return h; }
  void setH(const float &v) { h = v; }
...
struct Matrix {
  ...
  const float &getM00() const { return m00; }
  void setM00(const float &v) { m00 = v; }
  const float &getM01() const { return m01; }
  void setM01(const float &v) { m01 = v; }
  const float &getM02() const { return m02; }
  void setM02(const float &v) { m02 = v; }
  const float &getM10() const { return m10; }
  void setM10(const float &v) { m10 = v; }
  const float &getM11() const { return m11; }
  void setM11(const float &v) { m11 = v; }
  const float &getM12() const { return m12; }
  void setM12(const float &v) { m12 = v; }
...
struct Number {
  ...
  const NumberUnits &getUnits() const { return units; }
  void setUnits(const NumberUnits &v) { units = v; }
...
struct Color {
  ...
  void setR(const float &v) { r = v; }
  const float &getG() const { return g; }
  void setG(const float &v) { g = v; }
  const float &getB() const { return b; }
  void setB(const float &v) { b = v; }
  const float &getA() const { return a; }
  void setA(const float &v) { a = v; }
...
struct Effect {
  ...
  void setType(const EffectType &v) { type = v; }
...
struct DropShadowEffect {
  ...
  void setOffset(const Vector &v) { offset = v; }
  const float &getRadius() const { return radius; }
  void setRadius(const float &v) { radius = v; }
  const float &getSpread() const { return spread; }
  void setSpread(const float &v) { spread = v; }
  ...
  void setBlendMode(const BlendMode &v) { blendMode = v; }
  const bool &getShowShadowBehindNode() const { return showShadowBehindNode; }
  void setShowShadowBehindNode(const bool &v) { showShadowBehindNode = v; }
  ...
  void toChange(message::Effect &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::Effect::set_showShadowBehindNode,
                 showShadowBehindNode, pool);
  }
...
struct ColorStop {
  ...
  void setPosition(const float &v) { position = v; }
  const Color &getColor() const { return color; }
  void setColor(const Color &v) { color = v; }
...
struct Paint {
  ...
  const PaintType &getType() const { return type; }
  void setType(const PaintType &v) { type = v; }
  const bool &getVisible() const { return visible; }
  void setVisible(const bool &v) { visible = v; }
  const float &getOpacity() const { return opacity; }
  void setOpacity(const float &v) { opacity = v; }
  const BlendMode &getBlendMode() const { return blendMode; }
  void setBlendMode(const BlendMode &v) { blendMode = v; }
...
struct GradientPaint : public Paint {
  ...
  void setTransform(const Matrix &v) { transform = v; }
  const Array<ColorStop> &getStops() const { return stops; }
  void setStops(const Array<ColorStop> &v) { stops = v; }
...
struct ImagePaint : public Paint {
  ...
  const ImageScaleMode &getImageScaleMode() const { return imageScaleMode; }
  void setImageScaleMode(const ImageScaleMode &v) { imageScaleMode = v; }
  const Matrix &getTransform() const { return transform; }
  void setTransform(const Matrix &v) { transform = v; }
  ...
  void toChange(message::Paint &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::Paint::set_imageScaleMode, imageScaleMode,
                 pool);
    toChangeImpl(&change, &message::Paint::set_transform, transform, pool);
  }
...
struct Path {
  ...
  const WindingRule &getWindingRule() const { return windingRule; }
  void setWindingRule(const WindingRule &v) { windingRule = v; }
  const uint &getCommandsBlob() const { return commandsBlob; }
  void setCommandsBlob(const uint &v) { commandsBlob = v; }
...
struct ParentIndex {
  ...
  void setGuid(const GUID &v) { guid = v; }
  const string &getPosition() const { return position; }
  void setPosition(const string &v) { position = v; }
...
struct AssetRef {
  ...
  void setKey(const string &v) { key = v; }
...
struct StyleId {
  ...
  const GUID &getGuid() const { return guid; }
  void setGuid(const GUID &v) { guid = v; }
  const AssetRef &getAssetRef() const { return assetRef; }
  void setAssetRef(const AssetRef &v) { assetRef = v; }
...
struct ArcData {
  ...
  const float &getStartingAngle() const { return startingAngle; }
  void setStartingAngle(const float &v) { startingAngle = v; }
  const float &getEndingAngle() const { return endingAngle; }
  void setEndingAngle(const float &v) { endingAngle = v; }
  const float &getInnerRadius() const { return innerRadius; }
  void setInnerRadius(const float &v) { innerRadius = v; }
  ...
  void toChange(message::ArcData &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::ArcData::set_startingAngle, startingAngle,
                 pool);
    toChangeImpl(&change, &message::ArcData::set_endingAngle, endingAngle,
                 pool);
    toChangeImpl(&change, &message::ArcData::set_innerRadius, innerRadius,
                 pool);
  }
...
struct VectorData {
  ...
  const uint &getVectorNetworkBlob() const { return vectorNetworkBlob; }
  void setVectorNetworkBlob(const uint &v) { vectorNetworkBlob = v; }
  ...
  void toChange(message::VectorData &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::VectorData::set_vectorNetworkBlob,
                 vectorNetworkBlob, pool);
  }
...
struct Glyph {
  ...
  const uint &getStyleID() const { return styleID; }
  void setStyleID(const uint &v) { styleID = v; }
  const uint &getCommandsBlob() const { return commandsBlob; }
  void setCommandsBlob(const uint &v) { commandsBlob = v; }
  const Vector &getPosition() const { return position; }
  void setPosition(const Vector &v) { position = v; }
  const float &getFontSize() const { return fontSize; }
  void setFontSize(const float &v) { fontSize = v; }
  const float &getAdvance() const { return advance; }
  void setAdvance(const float &v) { advance = v; }
  ...
  void toChange(message::Glyph &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::Glyph::set_commandsBlob, commandsBlob,
                 pool);
...
struct Decoration {
  ...
  const Array<Rect> &getRects() const { return rects; }
  void setRects(const Array<Rect> &v) { rects = v; }
...
struct Baseline {
  ...
  void setWidth(const float &v) { width = v; }
  const float &getLineY() const { return lineY; }
  void setLineY(const float &v) { lineY = v; }
  const float &getLineHeight() const { return lineHeight; }
  void setLineHeight(const float &v) { lineHeight = v; }
  const float &getLineAscent() const { return lineAscent; }
  void setLineAscent(const float &v) { lineAscent = v; }
  const uint &getFirstCharacter() const { return firstCharacter; }
  void setFirstCharacter(const uint &v) { firstCharacter = v; }
  const uint &getEndCharacter() const { return endCharacter; }
  void setEndCharacter(const uint &v) { endCharacter = v; }
  ...
  void toChange(message::Baseline &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::Baseline::set_firstCharacter,
                 firstCharacter, pool);
    toChangeImpl(&change, &message::Baseline::set_endCharacter, endCharacter,
                 pool);
  }
...
struct TextData {
  ...
  void setCharacters(const string &v) { characters = v; }
  const Buffer &getStyleOverrideTable() const { return styleOverrideTable; }
  void setStyleOverrideTable(const Buffer &v) { styleOverrideTable = v; }
  const Vector &getLayoutSize() const { return layoutSize; }
  void setLayoutSize(const Vector &v) { layoutSize = v; }
  const Array<Baseline> &getBaselines() const { return baselines; }
  void setBaselines(const Array<Baseline> &v) { baselines = v; }
  const Array<Glyph> &getGlyphs() const { return glyphs; }
  void setGlyphs(const Array<Glyph> &v) { glyphs = v; }
  const Array<Decoration> &getDecorations() const { return decorations; }
  void setDecorations(const Array<Decoration> &v) { decorations = v; }
  ...
  void toChange(message::TextData &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::TextData::set_styleOverrideTable,
                 styleOverrideTable, pool);
    ...
    toChangeImpl(&change, &message::TextData::set_decorations, decorations,
                 pool);
  }
...
struct SymbolData {
  ...
  const GUID &getSymbolID() const { return symbolID; }
  void setSymbolID(const GUID &v) { symbolID = v; }
  const Buffer &getSymbolOverrides() const { return symbolOverrides; }
  void setSymbolOverrides(const Buffer &v) { symbolOverrides = v; }
  const float &getUniformScaleFactor() const { return uniformScaleFactor; }
  void setUniformScaleFactor(const float &v) { uniformScaleFactor = v; }
  ...
  void toChange(message::SymbolData &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::SymbolData::set_symbolOverrides,
                 symbolOverrides, pool);
    toChangeImpl(&change, &message::SymbolData::set_uniformScaleFactor,
                 uniformScaleFactor, pool);
  }
...
public:
  ...
  void setGuid(const GUID &v) { guid_ = v; }
  const ParentIndex &getParentIndex() const { return parentIndex_; }
  void setParentIndex(const ParentIndex &v) { parentIndex_ = v; }
  const string &getName() const { return name_; }
  void setName(const string &v) { name_ = v; }
  const NodeType &getType() const { return type_; }
  void setType(const NodeType &v) { type_ = v; }
  const BaseNodeMixinPointer &getNextSibling() const { return nextSibling_; }
  void setNextSibling(const BaseNodeMixinPointer &v) { nextSibling_ = v; }
  ...
  virtual void toChange(message::NodeChange &change,
                        kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_guid, guid_, pool);
    toChangeImpl(&change, &message::NodeChange::set_parentIndex, parentIndex_,
                 pool);
...
public:
  const boolean &getVisible() const { return visible_; }
  void setVisible(const boolean &v) { visible_ = v; }
  const boolean &getLocked() const { return locked_; }
  void setLocked(const boolean &v) { locked_ = v; }
...
public:
  const float &getCornerRadius() const { return cornerRadius_; }
  void setCornerRadius(const float &v) { cornerRadius_ = v; }
  const float &getCornerSmoothing() const { return cornerSmoothing_; }
  void setCornerSmoothing(const float &v) { cornerSmoothing_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_cornerRadius, cornerRadius_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_cornerSmoothing,
                 cornerSmoothing_, pool);
  }
};
...
public:
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change,
                 &message::NodeChange::set_rectangleTopLeftCornerRadius,
                 rectangleTopLeftCornerRadius_, pool);
    toChangeImpl(&change,
                 &message::NodeChange::set_rectangleTopRightCornerRadius,
                 rectangleTopRightCornerRadius_, pool);
    toChangeImpl(&change,
                 &message::NodeChange::set_rectangleBottomLeftCornerRadius,
                 rectangleBottomLeftCornerRadius_, pool);
    toChangeImpl(&change,
                 &message::NodeChange::set_rectangleBottomRightCornerRadius,
                 rectangleBottomRightCornerRadius_, pool);
  }
};
...
public:
  const float &getBorderTopWeight() const { return borderTopWeight_; }
  void setBorderTopWeight(const float &v) { borderTopWeight_ = v; }
  const float &getBorderBottomWeight() const { return borderBottomWeight_; }
  void setBorderBottomWeight(const float &v) { borderBottomWeight_ = v; }
  const float &getBorderLeftWeight() const { return borderLeftWeight_; }
  void setBorderLeftWeight(const float &v) { borderLeftWeight_ = v; }
  const float &getBorderRightWeight() const { return borderRightWeight_; }
  void setBorderRightWeight(const float &v) { borderRightWeight_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_borderTopWeight,
                 borderTopWeight_, pool);
    toChangeImpl(&change, &message::NodeChange::set_borderBottomWeight,
                 borderBottomWeight_, pool);
    toChangeImpl(&change, &message::NodeChange::set_borderLeftWeight,
                 borderLeftWeight_, pool);
    toChangeImpl(&change, &message::NodeChange::set_borderRightWeight,
                 borderRightWeight_, pool);
  }
};
...
public:
  const Array<PaintUnion> &getStrokePaints() const { return strokePaints_; }
  void setStrokePaints(const Array<PaintUnion> &v) { strokePaints_ = v; }
  const StyleId &getStyleIdForStrokeFill() const {
    return styleIdForStrokeFill_;
  }
  void setStyleIdForStrokeFill(const StyleId &v) { styleIdForStrokeFill_ = v; }
  const float &getStrokeWeight() const { return strokeWeight_; }
  void setStrokeWeight(const float &v) { strokeWeight_ = v; }
  const StrokeJoin &getStrokeJoin() const { return strokeJoin_; }
  void setStrokeJoin(const StrokeJoin &v) { strokeJoin_ = v; }
  const StrokeAlign &getStrokeAlign() const { return strokeAlign_; }
  void setStrokeAlign(const StrokeAlign &v) { strokeAlign_ = v; }
  const Array<float> &getDashPattern() const { return dashPattern_; }
  void setDashPattern(const Array<float> &v) { dashPattern_ = v; }
  const Array<Path> &getStrokeGeometry() const { return strokeGeometry_; }
  void setStrokeGeometry(const Array<Path> &v) { strokeGeometry_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_strokePaints, strokePaints_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_styleIdForStrokeFill,
                 styleIdForStrokeFill_, pool);
    toChangeImpl(&change, &message::NodeChange::set_strokeWeight, strokeWeight_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_strokeJoin, strokeJoin_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_strokeAlign, strokeAlign_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_dashPattern, dashPattern_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_strokeGeometry,
                 strokeGeometry_, pool);
  }
};
...
public:
  const Array<PaintUnion> &getFillPaints() const { return fillPaints_; }
  void setFillPaints(const Array<PaintUnion> &v) { fillPaints_ = v; }
  const StyleId &getStyleIdForStrokeFill() const {
    return styleIdForStrokeFill_;
  }
  void setStyleIdForStrokeFill(const StyleId &v) { styleIdForStrokeFill_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_fillPaints, fillPaints_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_styleIdForStrokeFill,
                 styleIdForStrokeFill_, pool);
  }
...
public:
  ...
  void setSize(const Vector &v) { size_ = v; }
  const Matrix &getTransform() const { return transform_; }
  void setTransform(const Matrix &v) { transform_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::NodeChange::set_transform, transform_,
                 pool);
  }
};
...
public:
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_horizontalConstraint,
                 horizontalConstraint_, pool);
    toChangeImpl(&change, &message::NodeChange::set_verticalConstraint,
                 verticalConstraint_, pool);
  }
};
...
public:
  const Array<Effect> &getEffects() const { return effects_; }
  void setEffects(const Array<Effect> &v) { effects_ = v; }
  const StyleId &getStyleIdForEffect() const { return styleIdForEffect_; }
  void setStyleIdForEffect(const StyleId &v) { styleIdForEffect_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::NodeChange::set_styleIdForEffect,
                 styleIdForEffect_, pool);
  }
};
...
public:
  const StackMode &getStackMode() const { return stackMode_; }
  void setStackMode(const StackMode &v) { stackMode_ = v; }
  const StackWrap &getStackWrap() const { return stackWrap_; }
  void setStackWrap(const StackWrap &v) { stackWrap_ = v; }
  const float &getStackPaddingRight() const { return stackPaddingRight_; }
  void setStackPaddingRight(const float &v) { stackPaddingRight_ = v; }
  const float &getStackPaddingBottom() const { return stackPaddingBottom_; }
  void setStackPaddingBottom(const float &v) { stackPaddingBottom_ = v; }
  ...
  const float &getStackVerticalPadding() const { return stackVerticalPadding_; }
  void setStackVerticalPadding(const float &v) { stackVerticalPadding_ = v; }
  ...
  void applyChange(const message::NodeChange &change) {
    ...
    if (change.stackHorizontalPadding() != nullptr) {
      applyChangeImpl(stackHorizontalPadding_,
                      *change.stackHorizontalPadding());
    }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_stackMode, stackMode_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_stackWrap, stackWrap_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_stackPaddingRight,
                 stackPaddingRight_, pool);
    toChangeImpl(&change, &message::NodeChange::set_stackPaddingBottom,
                 stackPaddingBottom_, pool);
    toChangeImpl(&change, &message::NodeChange::set_stackHorizontalPadding,
                 stackHorizontalPadding_, pool);
    toChangeImpl(&change, &message::NodeChange::set_stackVerticalPadding,
                 stackVerticalPadding_, pool);
  }
};
...
public:
  const StrokeCap &getStrokeCap() const { return strokeCap_; }
  void setStrokeCap(const StrokeCap &v) { strokeCap_ = v; }
  const float &getMiterLimit() const { return miterLimit_; }
  void setMiterLimit(const float &v) { miterLimit_ = v; }
  const Array<Path> &getFillGeometry() const { return fillGeometry_; }
  void setFillGeometry(const Array<Path> &v) { fillGeometry_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_strokeCap, strokeCap_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_miterLimit, miterLimit_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_fillGeometry, fillGeometry_,
                 pool);
...
class DefaultShapeNode : public BaseNodeMixin,
                         public SceneNodeMixin,
                         public ExportMixin,
                         public BlendMixin,
                         public GeometryMixin,
                         public LayoutMixin {
private:
public:
  void applyChange(const message::NodeChange &change) {
...
class BaseFrameMixin : public DefaultShapeNode,
                       public CornerMixin,
                       public RectangleCornerMixin,
                       public EffectMixin,
                       public ConstraintMixin,
                       public IndividualStrokesMixin {
private:
public:
  void applyChange(const message::NodeChange &change) {
...
public:
  const uint &getStyleID() const { return styleID_; }
  void setStyleID(const uint &v) { styleID_ = v; }
  const Number &getLetterSpacing() const { return letterSpacing_; }
  void setLetterSpacing(const Number &v) { letterSpacing_ = v; }
  const Number &getLineHeight() const { return lineHeight_; }
  void setLineHeight(const Number &v) { lineHeight_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    ...
    toChangeImpl(&change, &message::NodeChange::set_letterSpacing,
                 letterSpacing_, pool);
    toChangeImpl(&change, &message::NodeChange::set_lineHeight, lineHeight_,
                 pool);
    DefaultShapeNode::toChange(change, pool);
  }
};
...
class RectangleNodeBase : public DefaultShapeNode,
                          public ConstraintMixin,
                          public CornerMixin,
                          public RectangleCornerMixin,
                          public IndividualStrokesMixin {
...
class EllipseNodeBase : public DefaultShapeNode,
                        public ConstraintMixin,
                        public CornerMixin {
private:
  ArcData arcData_{};
...
public:
  const ArcData &getArcData() const { return arcData_; }
  void setArcData(const ArcData &v) { arcData_ = v; }
...
class PolygonNodeBase : public DefaultShapeNode,
                        public ConstraintMixin,
                        public CornerMixin {
private:
  uint count_{};
...
public:
  ...
  void setCount(const uint &v) { count_ = v; }
...
class StarNodeBase : public DefaultShapeNode,
                     public ConstraintMixin,
                     public CornerMixin {
private:
  uint count_{};
...
class VectorNodeBase : public DefaultShapeNode,
                       public ConstraintMixin,
                       public CornerMixin {
private:
...
public:
  const VectorData &getVectorData() const { return vectorData_; }
  void setVectorData(const VectorData &v) { vectorData_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_vectorData, vectorData_,
                 pool);
    DefaultShapeNode::toChange(change, pool);
    ConstraintMixin::toChange(change, pool);
    CornerMixin::toChange(change, pool);
...
public:
  const SymbolData &getSymbolData() const { return symbolData_; }
  void setSymbolData(const SymbolData &v) { symbolData_ = v; }
  const Buffer &getDerivedSymbolData() const { return derivedSymbolData_; }
  void setDerivedSymbolData(const Buffer &v) { derivedSymbolData_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_symbolData, symbolData_,
                 pool);
    toChangeImpl(&change, &message::NodeChange::set_derivedSymbolData,
                 derivedSymbolData_, pool);
    DefaultFrameMixin::toChange(change, pool);
  }
};
...
public:
  const TextData &getTextData() const { return textData_; }
  void setTextData(const TextData &v) { textData_ = v; }
...
public:
  ...
  void setBackgroundColor(const Color &v) { backgroundColor_ = v; }
  const float &getBackgroundOpacity() const { return backgroundOpacity_; }
  void setBackgroundOpacity(const float &v) { backgroundOpacity_ = v; }
  const bool &getBackgroundEnabled() const { return backgroundEnabled_; }
  void setBackgroundEnabled(const bool &v) { backgroundEnabled_ = v; }
  ...
  void toChange(message::NodeChange &change, kiwi::MemoryPool &pool) const {
    toChangeImpl(&change, &message::NodeChange::set_backgroundColor,
                 backgroundColor_, pool);
    toChangeImpl(&change, &message::NodeChange::set_backgroundOpacity,
                 backgroundOpacity_, pool);
    toChangeImpl(&change, &message::NodeChange::set_backgroundEnabled,
                 backgroundEnabled_, pool);
    BaseNodeMixin::toChange(change, pool);
  }
};
